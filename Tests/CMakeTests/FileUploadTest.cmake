file(REMOVE_RECURSE "/home/sorsak/cmake-3.17.3/Tests/CMakeTests/uploads")

if(EXISTS "/home/sorsak/cmake-3.17.3/Tests/CMakeTests/uploads/file1.png")
  message(FATAL_ERROR "error: file1.png exists - should have been deleted")
endif()
if(EXISTS "/home/sorsak/cmake-3.17.3/Tests/CMakeTests/uploads/file2.png")
  message(FATAL_ERROR "error: file2.png exists - should have been deleted")
endif()

file(MAKE_DIRECTORY "/home/sorsak/cmake-3.17.3/Tests/CMakeTests/uploads")

set(filename "/home/sorsak/cmake-3.17.3/Tests/CMakeTests/FileDownloadInput.png")
if(NOT "/home/sorsak/cmake-3.17.3/Tests/CMakeTests" MATCHES "^/")
  set(slash /)
endif()
set(urlbase "file://${slash}/home/sorsak/cmake-3.17.3/Tests/CMakeTests/uploads")
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "/home/sorsak/cmake-3.17.3/Tests/CMakeTests/uploads/file1.png"
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "/home/sorsak/cmake-3.17.3/Tests/CMakeTests/uploads/file2.png"
